...
public class CadenaServicio {
    ...
    public void invertirFrase(Cadena cad1){
        ...
        for (int i = cad1.getLargo()-1; i >= 0; i--) {
            cadenaInvertida=cadenaInvertida.concat(String.valueOf(cad1.getFrase().charAt(i)));
        }
    ...
    public void reemplazar(Cadena cad1){
        String caracter;
        System.out.println("La frase es "+cad1.getFrase());
        System.out.println("Ingrese un caracter para reemplazar la letra (a) de la frase");
        caracter=sc.nextLine();
        cad1.setFrase(cad1.getFrase().replaceAll("a", caracter));
        System.out.println(cad1.getFrase());
    }
    //G
